...
use super::types::{
    ...
    JiraProject, JiraProjectWithTypes, JiraTransition, ProjectSearchPage,
    ProjectWithTypesSearchPage, RawTransitionsResponse, SearchPage, DETAIL_FIELDS, LIST_FIELDS,
};
